...
void menu() {
  ...
  do {
    ...
    for (int i = 0; i < input.length(); ++i) {
      ...
      // the default case resumes the iterations of the loop and is run when the
      // current character is neither a 0 or 1
      default:
        continue;
      }
    }
...
// pushes the character to the char vector by reference without needing to
...
// function to validate the contents of the string to determine if it contains
// the substring '1101'
