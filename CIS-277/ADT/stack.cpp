...
public:
	...
	void Push(int num)
	{ // appends the num to the top of the Stack
	...
	void Print()
	{
		...
		for (int i = 0; i <= top; i++)
		{ // prints all the elements up to and including the top of the Stack
