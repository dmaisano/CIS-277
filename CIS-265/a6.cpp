...
int main() {
    ...
    else if(numChecks >= 20 && numChecks <= 39) { // if the checks written are between 29-39, charge 8 cents per check
        charges += (numChecks * 0.08);
    }

    else if(numChecks >= 40 && numChecks <= 59) { // if the checks written are between 39-49, charge 6 cents per check
