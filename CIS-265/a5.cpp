...
2. Processing:
        ...
        e. if(seconds >= 3600 && seconds < 86400) // display number of hours and
minutes f. if(seconds >= 86400) // display number of days, hours, and minutes

3. Output:
        a. cout << "Seconds entered: " << seconds << " = " << days << " day(s),
" << hours << " hour(s), and " << minutes << " minute(s)."; // display number of
Days, Hours, and Minutes based on input of seconds from user
*/
...
int main() {
  ...
  days = seconds /
         86400; // calculation for number of days using the value of seconds
  ...
  // less than a day
    ...
    cout << "Seconds entered: " << seconds << " = " << hours << " hour(s), and "
         << minutes << " minute(s).";
  }
  ...
  // day (86400 seconds)
    ...
    cout << "Seconds entered: " << seconds << " = " << days << " day(s), "
